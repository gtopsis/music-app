...
describe("GET /v1/artists", () => {
  it("Retrieve all artists successfully", async () => {
    const response = await request(app).get("/v1/artists").set("Accept", "application/json").expect(200);
  });
});
...
//     const response = await request(app).delete("/v1/artists").set("Accept", "application/json").expect(200);
//   });
// });
